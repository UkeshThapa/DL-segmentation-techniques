...
class Logger:
	...
	def save_model_and_optimizer(self, model, optim, file_name):
		out_dir = 'E:/projects/X-ray/semantic-segmentation-pytorch/runs/models/{}'.format(self.data_subdir)
		if not Logger._exist(out_dir):
			Logger._make_dir(out_dir)
	...
	def load_model(self, model, file_name):
		dir = 'E:/projects/X-ray/semantic-segmentation-pytorch/runs/models/{}'.format(self.data_subdir)
